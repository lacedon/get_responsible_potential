...
var Comp = {
  ...
  'pow': function(x, n){ if(typeof x == 'number'){x = new Complex(x);} return x.pow(n);       },
  'exp': function(x){    if(typeof x == 'number'){x = new Complex(x);} return x.exp();        },
  'neg': function(x){    if(typeof x == 'number'){x = new Complex(x);} return x.negative();   },
  'con': function(x){    if(typeof x == 'number'){x = new Complex(x);} return x.conjugate();  },
  'abs': function(x){    if(typeof x == 'number'){x = new Complex(x);} return x.abs();        }
};